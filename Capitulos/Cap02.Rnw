...
{\em Sea $E$ un espacio vectorial, por una relación $\C{R}$ en $E$ entendemos el subconjunto de $E\times E$, tal que satisface las siguientes propiedades:\\[2mm]
...
{\em Una relación, se dice de \emph{\bf equivalencia} si ésta es reflexiva, simétrica y transitiva.}
\end{definition}
...
\begin{definition}[Clases de Equivalencia] 
{\em Sea $E$ un espacio vectorial y sea $\C{R}$ una relación de equivalencia en $E$. Si $x\in E$, entonces la clase de equivalencia de $x$ dado $\C{R}$, es el conjunto $\C{R}_x$ definido como: 
 \[\mathcal{R}_x=\{y\in E~/~(y,x)\in \mathcal{R}\}=\{y\in E~/~y\thicksim x\}\] 
dicho de otro modo, $\mathcal{R}_x$ es el conjunto de todos los elementos de $E$ que son equivalentes a $x$. Las clases de equivalencia se las nota de la forma $x/\C{R}$.}
\end{definition}

\begin{definition}[Conjunto Cociente]
{\em Si $\C{R}$ es una relación de equivalencia en un espacio vectorial $E$, entonces el conjunto de las clases de equivalencia de $\C{R}$, se denomina {\bf conjunto cociente} de $E$ por $\C{R}$ y se nota como $E/\C{R}$.}
\end{definition}
...
\begin{definition}
{\em Sea $E$ un espacio vectorial, y $F$ un subespacio vectorial de $E$, la relación de equivalencia de $x\in E$ se define como:
...
\begin{definition}
{\em Sea $E$ un espacio vectorial, y $F$ un subespacio vectorial de $E$, además si $x\in E$, se define el {\bf co - conjunto} como:
...
\begin{definition}
{\em Sea $E$ un espacio vectorial, y $F$ un subespacio vectorial de $E$, entonces llamaremos {\bf espacio vectorial cociente} al espacio $E/F$ definido como:
